...
Item {
  ...
  component BarPanel: PanelWindow {
    ...
    // Frosted-glass tint. The compositor blur is optional; this translucent
    // surface keeps the glass appearance visible even when Hyprland blur is
    // disabled by the active system/theme settings.
    BorderSurface {
      anchors.fill: parent
  ...
  component CenterGestureArea: MouseArea {
    ...
    // Keep left-button dragging and use a simple left-click as the glass toggle.
